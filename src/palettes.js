...
export const PALETTES = [
  {
    ...
    night: {
      bg: "#1a1714", paper: "#221e1a", s2: "#2a251f", sunken: "#29241f",
  ...
  },
  {
    ...
    night: {
      bg: "#1b1618", paper: "#241e20", s2: "#2c2427", sunken: "#2d2528",
      bd: "#332a2d", bds: "#4c4044",
      ink: "#ebe0de", sec: "#b7a5a4", mut: "#9e8a87",
      act: "#d49aa0", actHover: "#e0adb2", on: "#241e20",
  ...
  },
  {
    ...
    night: {
      bg: "#1a151c", paper: "#231c26", s2: "#2b232e", sunken: "#302733",
  ...
  },
  {
    ...
    night: {
      bg: "#141a1a", paper: "#1c2424", s2: "#232c2c", sunken: "#222b2b",
      bd: "#2a3434", bds: "#3e4a4a",
      ink: "#e3e9e7", sec: "#a6b3b1", mut: "#879391",
      act: "#6fb6a4", actHover: "#87c6b6", on: "#1c2424",
  ...
  },
  {
    ...
    night: {
      bg: "#14181c", paper: "#1c2126", s2: "#232930", sunken: "#232930",
